                ...
                <div class="inner">
                    <div class="row">
                        ...
                        <div class="col-lg-2 col-12 d-flex align-items-center">
                            <div class="get-quote d-flex align-items-center">
                                <a style="display:none" class="btn text-white trigger-modal-btn">Get Free Trial</a>
                                <a class="btn text-white trigger-modal-btn1">Book A Demo</a>
